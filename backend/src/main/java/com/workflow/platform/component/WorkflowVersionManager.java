...
public class WorkflowVersionManager {
    ...
    public WorkflowVersionDTO createBranch(String workflowId, int baseVersion,
        ...
        try {
            ...
            WorkflowVersionDTO branchVersion = WorkflowVersionDTO.builder()
                    .id(generateVersionId(branchWorkflow.getId(), 1))
                    .workflowId(branchWorkflow.getId())
                    .versionNumber(1)
                    .versionTag("branch/" + branchName + "/v1")
                    .description("分支创建: " + description)
                    .workflowData(branchWorkflow)
                    .createdBy(createdBy)
                    .createdAt(System.currentTimeMillis())
                    .isBranch(true)
    ...
    public VersionStats getVersionStats(String workflowId) {
        ...
        try {
            ...
            stats.setLastVersionTime(versions.isEmpty() ? 0 :
                    versions.get(versions.size() - 1).getCreatedAt());
    ...
    private Map<String, Object> generateMetadata(WorkflowDTO workflow) {
        ...
        metadata.put("validationRuleCount", workflow.getValidationRules() != null ? workflow.getValidationRules().size() : 0);
    ...
    public static class VersionComparison {
        ...
        public void setComparedAt(long comparedAt) { this.comparedAt = comparedAt; }

        public List<BasicChange> getBasicChanges() { return basicChanges; }
        public void setBasicChanges(List<BasicChange> basicChanges) { this.basicChanges = basicChanges; }

        public List<NodeChange> getNodeChanges() { return nodeChanges; }
        public void setNodeChanges(List<NodeChange> nodeChanges) { this.nodeChanges = nodeChanges; }

        public List<ConnectionChange> getConnectionChanges() { return connectionChanges; }
        public void setConnectionChanges(List<ConnectionChange> connectionChanges) { this.connectionChanges = connectionChanges; }
    ...
    public static class NodeChange {
        ...
        public Object getOldNode() { return oldNode; }
        public Object getNewNode() { return newNode; }
    }
    ...
    public static class MergeResult {
        ...
        public void setSourceWorkflowId(String sourceWorkflowId) { this.sourceWorkflowId = sourceWorkflowId; }

        public String getTargetWorkflowId() { return targetWorkflowId; }
        public void setTargetWorkflowId(String targetWorkflowId) { this.targetWorkflowId = targetWorkflowId; }
        ...
        public long getMergeTime() { return mergeTime; }
        ...
        public boolean isNeedsManualResolution() { return needsManualResolution; }
        public void setNeedsManualResolution(boolean needsManualResolution) { this.needsManualResolution = needsManualResolution; }
    ...
    public static class VersionStats {
        ...
        public long getFirstVersionTime() { return firstVersionTime; }
        public void setFirstVersionTime(long firstVersionTime) { this.firstVersionTime = firstVersionTime; }

        public long getLastVersionTime() { return lastVersionTime; }
        public void setLastVersionTime(long lastVersionTime) { this.lastVersionTime = lastVersionTime; }

        public long getAverageVersionInterval() { return averageVersionInterval; }
        public void setAverageVersionInterval(long averageVersionInterval) { this.averageVersionInterval = averageVersionInterval; }

        public Map<String, Integer> getCreatorStats() { return creatorStats; }
        public void setCreatorStats(Map<String, Integer> creatorStats) { this.creatorStats = creatorStats; }

        public Map<String, Integer> getTagStats() { return tagStats; }
        public void setTagStats(Map<String, Integer> tagStats) { this.tagStats = tagStats; }
    ...
    public static class CleanupCriteria {
        ...
        // Getters and Setters
        public boolean getKeepTagged() { return keepTagged; }
        public void setKeepTagged(boolean keepTagged) { this.keepTagged = keepTagged; }

        public boolean getKeepMajorVersions() { return keepMajorVersions; }
        public void setKeepMajorVersions(boolean keepMajorVersions) { this.keepMajorVersions = keepMajorVersions; }

        public int getMaxAgeDays() { return maxAgeDays; }
        public void setMaxAgeDays(int maxAgeDays) { this.maxAgeDays = maxAgeDays; }

        public int getKeepLastVersions() { return keepLastVersions; }
        public void setKeepLastVersions(int keepLastVersions) { this.keepLastVersions = keepLastVersions; }
    }
    ...
    public static class CleanupResult {
        ...
        public int getKeptVersions() { return keptVersions; }
        public void setKeptVersions(int keptVersions) { this.keptVersions = keptVersions; }

        public int getDeletedVersions() { return deletedVersions; }
        public void setDeletedVersions(int deletedVersions) { this.deletedVersions = deletedVersions; }

        public long getDeletedSize() { return deletedSize; }
        public void setDeletedSize(long deletedSize) { this.deletedSize = deletedSize; }
    ...
    public static class VersionHistoryExport {
        ...
        public VersionStats getStats() { return stats; }
        public void setStats(VersionStats stats) { this.stats = stats; }
    }
}