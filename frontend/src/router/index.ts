  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'instances', name: 'instances', component: () => import('@/views/InstanceListView.vue'), meta: { title: '实例列表' } },
        { path: 'tickets', name: 'tickets', component: () => import('@/views/TicketListView.vue'), meta: { title: '工单列表' } },
